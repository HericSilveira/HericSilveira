...
**Produto próprio**
- **Mercado Gestor** — SaaS de PDV/ERP para mercados: operação de caixa, controle de produtos e gestão do estabelecimento.

**Para clientes** *(em produção)*
...
> 💡 Boa parte do meu código está em produtos comerciais ou sob NDA, então nem tudo aparece público aqui. O [portfólio](https://www.codeart.dev.br) mostra o que entreguei.

📫 **Contato:** Hericsilveira2010@outlook.com.br
